  ...
  <div class="im-box">
    ...
    >
      <div class="import_box">
        <div class="nav__box">
          <m-rearchTip :show="rearchKey" :type="rearchType"/>
          <span :class="['nav__item',{'active':activeKey1}]" @click="modelImport">模型导入</span>
          <span :class="['nav__item',{'active':activeKey2}]" @click="imgImport">图片导入</span>
        </div>

        <div class="import__content">
          <div class="one" v-show="activeKey1">
            <div class="shoot-inp">
              <div class="inp-con">
                <label for="five">
